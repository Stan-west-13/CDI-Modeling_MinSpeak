...
```{r,message=FALSE, echo =  FALSE, fig.fullwidth=TRUE}
d_matched_td%>%
  select(subjectkey, nproduced_total,nouns_produced = nproduced, interview_age) %>%
...
-   3-way ANOVA revealed no differences in number of nouns produced
    between the TD and two ASD groups $F(2,485) = 0.1, p = 0.905$.
